...
@Component({
  selector: 'app-projets-termine',
  templateUrl: './projets-termine.component.html',
  styleUrls: ['./projets-termine.component.css']
})
export class ProjetsTermineComponent implements OnInit {
 ...
 public selectNullValue:number;
   public getProjects() {
     this.projectsService.getFinished(this.searchCriteria).subscribe(data => {
