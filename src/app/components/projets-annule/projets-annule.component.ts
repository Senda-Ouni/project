...
@Component({
  selector: 'app-projets-annule',
  templateUrl: './projets-annule.component.html',
  styleUrls: ['./projets-annule.component.css']
})
export class ProjetsAnnuleComponent implements OnInit {
 ...
 public selectNullValue:number;
   public getProjects() {
     this.projectsService.getCancelled(this.searchCriteria).subscribe(data => {
