...
@Component({
  selector: 'app-projets-planifie',
  templateUrl: './projets-planifie.component.html',
  styleUrls: ['./projets-planifie.component.css']
})
export class ProjetsPlanifieComponent implements OnInit {
 ...
 public selectNullValue:number;
   public getProjects() {
     this.projectsService.getScheduled(this.searchCriteria).subscribe(data => {
