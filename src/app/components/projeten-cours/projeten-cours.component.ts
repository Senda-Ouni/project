...
@Component({
  selector: 'app-projeten-cours',
  templateUrl: './projeten-cours.component.html',
  styleUrls: ['./projeten-cours.component.css']
})
export class ProjetenCoursComponent implements OnInit {
 ...
 public selectNullValue:number;
   public getProjects() {
     this.projectsService.getStarted(this.searchCriteria).subscribe(data => {
