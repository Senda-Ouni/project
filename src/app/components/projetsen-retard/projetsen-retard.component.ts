...
@Component({
  selector: 'app-projetsen-retard',
  templateUrl: './projetsen-retard.component.html',
  styleUrls: ['./projetsen-retard.component.css']
})
export class ProjetsenRetardComponent implements OnInit {
 ...
 public selectNullValue:number;
   public getProjects() {
     this.projectsService.getLate(this.searchCriteria).subscribe(data => {
